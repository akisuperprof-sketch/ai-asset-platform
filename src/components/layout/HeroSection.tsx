...
export function HeroSection({ onSearch }: { onSearch?: (query: string) => void }) {
  ...
  return (
    <div className="relative min-h-[100dvh] lg:h-[100dvh] flex flex-col pt-20 lg:pt-24 pb-4 lg:pb-0 overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 flex-1 max-w-7xl mx-auto px-6 w-full flex flex-col justify-between h-full pt-2 lg:pt-4">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between w-full flex-shrink-0">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-3 lg:mb-4">
                <div className="bg-white/5 backdrop-blur-md border border-white/10 px-4 py-1.5 rounded-full flex items-center gap-2">
                  ...
                  <span className="text-[9px] lg:text-[10px] font-black text-white uppercase tracking-[0.25em]">
                    日本発のAI透過素材プラットフォーム
                  </span>
                </div>
              </div>
              ...
              {/* Huge Typography */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-[4.5rem] font-black text-white leading-[0.95] tracking-tighter mb-3 lg:mb-4 drop-shadow-2xl flex flex-col gap-1 lg:gap-2">
              ...
              {/* Description */}
              <p className="text-xs sm:text-sm lg:text-base text-secondary max-w-lg leading-relaxed font-medium">
          ...
          <div className="w-full lg:w-1/2 h-[200px] sm:h-[250px] lg:h-[350px] relative flex items-center justify-center mt-4 lg:mt-0">
            <motion.div
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute w-[200px] h-[200px] lg:w-[350px] lg:h-[350px] border border-ai-cyan/20 rounded-full border-dashed"
              />
              <motion.div 
                animate={{ rotate: -360 }}
                transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
                className="absolute w-[180px] h-[180px] lg:w-[300px] lg:h-[300px] border-[0.5px] border-ai-purple/30 rounded-full"
              />
              ...
              >
                {!imgError ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center gap-4">
                    <img src="/brand/icon-shuriken.svg" alt="Loading" className="w-16 h-16 opacity-30 animate-spin" style={{ animationDuration: '3s' }} />
        ...
        <div className="flex flex-col w-full z-20 mt-2 lg:mt-6 pb-4 lg:pb-8">
          
          {/* Centered Search Bar */}
          <div className="w-full max-w-3xl mx-auto mb-3 lg:mb-4">
            <form onSubmit={handleSearch} className="relative group w-full">
              ...
              <div className="relative flex items-center bg-black/60 backdrop-blur-3xl border border-white/20 rounded-[2rem] overflow-hidden shadow-[inset_0_0_20px_rgba(255,255,255,0.05)]">
                <Search className="absolute left-5 w-4 h-4 lg:w-5 lg:h-5 text-ai-cyan group-focus-within:text-ai-purple transition-colors" />
                <input
                  type="text"
                  value={query}
                  onChange={(e) => setQuery(e.target.value)}
                  placeholder="素材を検索 (例: おにぎり、寿司、ビジネス...)"
                  className="w-full h-12 lg:h-14 bg-transparent px-8 pl-12 lg:pl-14 text-white placeholder-white/30 focus:outline-none text-xs lg:text-sm font-medium"
                />
                <div className="pr-1 lg:pr-2">
                  <button 
                    type="submit"
                    className="bg-ai-gradient px-4 py-2 lg:px-6 lg:py-2.5 rounded-full text-white text-[9px] lg:text-[10px] font-black uppercase tracking-widest hover:brightness-125 hover:shadow-[0_0_15px_rgba(168,85,247,0.6)] active:scale-95 transition-all"
                  >
                    検索
                  </button>
                </div>
          ...
          {/* Popular Tags */}
          <div className="flex flex-wrap items-center justify-center gap-2 lg:gap-3 text-[9px] lg:text-[10px] text-white/40 font-black uppercase tracking-widest mb-4 lg:mb-6">
            ...
            {["おにぎり", "ラーメン", "桜", "富士山", "寿司", "和食", "ビジネス", "医療"].map(tag => (
              <button 
                ...
                className="hover:text-white transition-colors border border-white/10 rounded-full px-2 lg:px-3 py-1 bg-white/5 hover:bg-white/10"
              >
                #{tag}
              </button>
            ))}
          ...
          <div className="w-full max-w-5xl mx-auto glass rounded-[1.5rem] lg:rounded-[2rem] border-white/10 shadow-2xl p-3 lg:p-4 mb-4 lg:mb-6">
            <div className="flex gap-4 lg:gap-8 overflow-x-auto no-scrollbar justify-start md:justify-center items-center px-4 lg:px-0">
              {[
                ...
                >
                  <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-full bg-black/60 border border-white/10 flex items-center justify-center text-xl lg:text-2xl group-hover:bg-ai-gradient group-hover:border-transparent group-hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] transition-all duration-300">
          ...
          <div className="flex justify-center items-center gap-3 lg:gap-4 text-[8px] lg:text-[9px] font-black tracking-[0.3em] text-white/30">
            <span className="flex items-center gap-2"><span className="w-1.5 h-1.5 lg:w-2 lg:h-2 rounded-full bg-red-600"></span>MADE IN JAPAN</span>
